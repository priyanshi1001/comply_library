...
export function W9() {
  ...
  const [selectedTaxClassification, setSelectedTaxClassification] = useState<string>('');
 ...
 const handleChange = (e: React.ChangeEvent<HTMLInputElement> ) :void => {
  ...
  return (
    <div className='col-12' style={{ backgroundColor: '#0c3d69', marginBottom: '10px', padding: '20px' }}>
...
{selectedContinue.step1 ? (
  <>
   <Paper style={{ marginLeft: '5px', width: '80%' }} >
          <div >
            <Typography align='left' style={{ margin: '10px' }}>
              <div style={{ display: "flex",justifyContent:'space-between' }}>
                ...
                <Typography align='left' style={{ color: 'black', fontSize: '20px', fontWeight: "550" }}>Select your status for U.S. tax purposes</Typography>
               <Typography align='right'>
               <Button   style={{ color: 'black', backgroundColor: '#ffc107', fontWeight: "550" ,justifyContent:"flex-end"}}>
                  Federal Tax Classification Guide
                </Button>
               </Typography>
               
              </div>
              <div className="col-lg-3 col-6 col-md-3 mt-3" style={{ marginTop: '20px' }}>
                <Typography align="left" className="d-flex w-100 " style={{ fontSize: "13px" }}>
              ...
              {selectedTaxClassification === '258' ? (
                <>
                  ...
                  <div>
                    <Typography align="left" className="d-flex w-100 " style={{ fontSize: "13px", marginTop: '15px' }}>
        ...
        <Button 
          ...
          onClick={() => {
            setselectedContinue({step1:false,step2:true,step3:false,step4:false,step5:false,step6:false,step7:false,step8:false})
            // setOpen(true);
 ...
 {selectedContinue.step2 ? (<Paper  style={{ marginLeft: '5px', width: '80%' }}>
  <div style={{ margin: '10px' }}>
    <Typography align='left' style={{color: 'black', fontSize: '20px', fontWeight: "550"}}>Exemption from Backup Withholding for U.S. Business & Organizations <span style={{ color: 'red' }}>*</span>
                  <InfoIcon
                    style={{ color: '#ffc107', fontSize: '13px' }}

                  /> </Typography>
    <Typography align='left' style={{fontSize:"13px",marginTop:"10px"}}>
    Generally, individuals (including sole proprietors) are not exempt from backup withholding.
    </Typography>
    <Typography align='left' style={{fontSize:"13px",fontWeight:"550",marginTop:"10px"}}>
    Is the business or organization you are making this submission for exempt from backup withholding? <span style={{ color: 'red' }}>*</span>
                  <InfoIcon
                    style={{ color: '#ffc107', fontSize: '13px' }}
    ...
    <RadioGroup
      ...
      >
        ...
        <FormControlLabel value="other" control={<Radio />} label="Don't know" />
  ...
  <div style={{ display: 'flex', justifyContent: 'center', marginTop: '80px' }}>
        ...
        <Button 
          ...
          onClick={() => {
            setselectedContinue({step1:false,step2:false,step3:true,step4:false,step5:false,step6:false,step7:false,step8:false})
            // setOpen(true);
...
{/* step3 */}
{selectedContinue.step3 ? ( <Paper  style={{ marginLeft: '5px', width: '80%' }}>
<div style={{ margin: '10px' }}>
  <Typography align='left' style={{ margin: '10px',fontSize:"20px" }}>Exemption from FATCA reporting<span style={{ color: 'red' }}>*</span>
                      <InfoIcon
                        style={{ color: '#ffc107', fontSize: '13px' }}

                      /> </Typography>
  <Typography align='left' style={{fontSize:"12px",marginTop:"10px"}}>Will payments be made into an account held outside of the United States by a foreign institution?</Typography>
  ...
  <div style={{marginTop:"20px",justifyContent:"center"}}>
    <RadioGroup
      ...
      >
        <FormControlLabel value={257} control={<Radio />} label="Yes" />
        <FormControlLabel value={258} control={<Radio />} label="No" />
  ...
  {report === '257' ? (
    <>
  <Typography align='left' style={{fontSize:"12px",marginTop:"10px"}}>Please select from the list provided to apply for exemption from FATCA Reporting or select confirm if no exemption applies<span style={{ color: 'red' }}>*</span>
                      <InfoIcon
                        style={{ color: '#ffc107', fontSize: '13px' }}
...
<div style={{ display: 'flex', justifyContent: 'center', marginTop: '80px' }}>
        ...
        <Button 
          ...
          onClick={() => {
            setselectedContinue({step1:false,step2:false,step3:false,step4:true,step5:false,step6:false,step7:false,step8:false})
...
{selectedContinue.step4 ?(<Paper  style={{ marginLeft: '5px', width: '80%' }}>
<Typography align='left' style={{ margin: '10px',fontSize:"20px" }}>Taxpayer Identification Number <span style={{ color: 'red' }}>*</span>
                      <InfoIcon
                        style={{ color: '#ffc107', fontSize: '13px' }}
...
<Input
        ...
        <Button 
          ...
          onClick={() => {
            setselectedContinue({step1:false,step2:false,step3:false,step4:false,step5:true,step6:false,step7:false,step8:false})
            // setOpen(true);
...
{selectedContinue.step5 ?(<Paper  style={{ marginLeft: '5px', width: '80%' }}>
<Typography align='left' style={{ margin: '10px',fontSize:"20px" ,fontWeight:'550'}}>Attach Supporting Documentation <span style={{ color: 'red' }}>*</span>
                      <InfoIcon
                        style={{ color: '#ffc107', fontSize: '13px',verticalAlign:"super" }}

                      /> </Typography>
                      <div style={{margin:'20px'}}>
                      <div style={{margin:'10px',display:"flex",marginTop:"20px",justifyContent:"space-between"}}>
                       <div>
                       <Typography align='left'>
                       Birth Certificate (Copy)
                       </Typography>
                       <Typography align='left'style={{fontSize:'13px',color:"grey"}}>A government issued document that registers the birth of the holder</Typography>
...
<Input type='file'
                      ...
                      <div style={{margin:'10px',display:"flex",marginTop:"20px",justifyContent:"space-between"}}>
                       ...
                       <Typography align='left' style={{fontSize:'13px',color:"grey"}}>Certificate of Incorporation
</Typography>
...
<Input type='file'
                      ...
                      <div style={{margin:'10px',display:"flex",marginTop:"20px",justifyContent:"space-between"}}>
                       ...
                       <Typography align='left'style={{fontSize:'13px',color:"grey"}}>Driving License
</Typography>
...
<Input type='file'
                      ...
                      <div style={{margin:'10px',display:"flex",marginTop:"20px",justifyContent:"space-between"}}>
                       ...
                       <Typography align='left' style={{fontSize:'13px',color:"grey"}}>Passport</Typography>
...
<Input type='file'
                      ...
                      <div style={{margin:'10px',display:"flex",marginTop:"20px",justifyContent:"space-between"}}>
                       ...
                       <Typography align='left' style={{fontSize:'13px',color:"grey"}}>Power of Attorney statement</Typography>
...
<Input type='file'
                      ...
                      <div style={{margin:'10px',display:"flex",marginTop:"20px",justifyContent:"space-between"}}>
                       ...
                       <Typography align='left' style={{fontSize:'13px',color:"grey"}}>Proof of Residency</Typography>
...
{selectedContinue.step6 ?(<Paper  style={{ marginLeft: '5px', width: '80%' }}>
...
<Typography align='left' style={{ margin: '10px',fontSize:"20px" ,fontWeight:'550'}}>Part II Certification<span style={{ color: 'red' }}>*</span>
      ...
      <Typography style={{fontSize:'13px',color:'black',marginTop:'7px'}}>
        ...
        <Button 
          ...
          onClick={() => {
            setselectedContinue({step1:false,step2:false,step3:false,step4:false,step5:false,step6:false,step7:false,step8:false})
